...
## MultiRoute Webservice API

-   [MultiRoute Webservice API](#MultiRoute-Webservice-API)
-   [Webservice-Request](#Webservice-Request)
    -   [Das Webservice-Request-Objekt](#Das-Webservice-Request-Objekt)
        -   [HTTP Methode:](#HTTP-Methode)
        -   [Format / ContentType](#Format-ContentType)
    -   [Das JSON-POST-Object](#Das-JSON-POST-Object)
        -   ["tour":](#tour)
        -   ["waypoints":](#waypoints)
            -   [address](#address)
            -   [coordinate](#coordinate)
            -   [time](#time)
            -   [time mit Zeitfenster](#time-mit-Zeitfenster)
            -   [Achtung](#Achtung)
            -   [links](#links)
            -   [Beispiel Waypoints ohne
                Zeitfenster](#Beispiel-Waypoints-ohne-Zeitfenster)
            -   [Beispiel Waypoints mit
                Zeitfenster](#Beispiel-Waypoints-mit-Zeitfenster)
    -   [Webservice-Response-Objekt](#Webservice-Response-Objekt)
        -   [Format / ContentType](#Format-ContentType)
        -   [Das JSON-Object](#Das-JSON-Object)
            -   [Beispiel](#Beispiel)
    -   [Beispielaufruf mit curl](#Beispielaufruf-mit-curl)
-   [Webservice-Result](#Webservice-Result)
    -   [Der Webservice-Result-Aufruf](#Der-Webservice-Result-Aufruf)
    -   [Das JSON-Object](#Das-JSON-Object)
        -   ["tour":](#tour)
            -   [Beispiel](#Beispiel)
            -   [Parameter status](#Parameter-status)
            -   [Parameter
                time\_window\_error](#Parameter-time_window_error)
            -   [Zeitplanung mit Zeitfenster Fehler
                1](#Zeitplanung-mit-Zeitfenster-Fehler-1)
            -   [Zeitplanung mit Zeitfenster Fehler
                2](#Zeitplanung-mit-Zeitfenster-Fehler-2)
        -   ["waypoints":](#waypoints)
            -   [Achtung:](#Achtung)
            -   [Parameter address (wird nicht
                verändert)](#Parameter-address-wird-nicht-verändert)
            -   [Parameter geocode\_address Gefundene
                Adresse](#Parameter-geocode_address-Gefundene-Adresse)
            -   [Parameter coordinate](#Parameter-coordinate)
            -   [Parameter
                building\_coordinate](#Parameter-building_coordinate)
            -   [Parameter time](#Parameter-time)
            -   [Achtung](#Achtung)
            -   [Beispiel](#Beispiel)
-   [Webservice-Status](#Webservice-Status)
    -   [Der Webservice-Status-Aufruf](#Der-Webservice-Status-Aufruf)
    -   [Das JSON-Object](#Das-JSON-Object)
        -   [Parameter status](#Parameter-status)
        -   [Parameter error\_text](#Parameter-error_text)
        -   [Parameter
            time\_window\_error](#Parameter-time_window_error)
            -   [Zeitplanung mit Zeitfenster Fehler
                1:](#Zeitplanung-mit-Zeitfenster-Fehler-1)
            -   [Zeitplanung mit Zeitfenster Fehler
                2:](#Zeitplanung-mit-Zeitfenster-Fehler-2)
-   [Webservice-StaticMap](#Webservice-StaticMap)
    -   [Ausgabe-Steuerung](#Ausgabe-Steuerung)
        -   [zulässige Werte /
            Beschränkung:](#zulässige-Werte-Beschränkung)
        -   [Default-Werte:](#Default-Werte)
    -   [Fehlerfall](#Fehlerfall)
    -   [Erfolgsfall](#Erfolgsfall)
    -   [vor Verwendung](#vor-Verwendung)
    -   [Beispielaufruf mit Curl](#Beispielaufruf-mit-Curl)
        -   [Beispiel-Ergebnis](#Beispiel-Ergebnis)
-   [Webservice-Optimierung](#Webservice-Optimierung)
    -   [Der
        Webservice-Optimierung-Aufruf](#Der-Webservice-Optimierung-Aufruf)
    -   [GET Parameter](#GET-Parameter)
        -   [Beispiel](#Beispiel)
-   [Postleitzahlen entlang der Tour](#Postleitzahlen-entlang-der-Tour)
    -   [Webservice-Aufruf](#Webservice-Aufruf)
        -   [Ohne Puffer:](#Ohne-Puffer)
        -   [Optional zusätzlich mit
            Puffer:](#Optional-zusätzlich-mit-Puffer)
        -   [Ergebnis](#Ergebnis)
        -   [Erweiterung](#Erweiterung)
-   [Webservice-AdditionalPoints](#Webservice-AdditionalPoints)
    -   ["waypoints":](#waypoints)
        -   -   [address](#address)
            -   [coordinate](#coordinate)
            -   [time](#time)
            -   [Achtung](#Achtung)
    -   [Beispiel](#Beispiel)
    -   [Curl Beispiel](#Curl-Beispiel)
-   [Webservice Download](#Webservice-Download)
    -   [Der
        Webservice-Download-Aufruf](#Der-Webservice-Download-Aufruf)
    -   [Formate](#Formate)
        -   [Formate abfragen](#Formate-abfragen)
        -   [Spezialformate im Browser für Mobile
            Navigation](#Spezialformate-im-Browser-für-Mobile-Navigation)
-   [Weitere Aufrufe](#Weitere-Aufrufe)
    -   [Webservice-Delete](#Webservice-Delete)
        -   [Rückgabe](#Rückgabe)
    -   [Dynamische Karte](#Dynamische-Karte)
        -   [Karte mit einer Tour
            anzeigen](#Karte-mit-einer-Tour-anzeigen)
            -   [Rückgabe](#Rückgabe)
        -   [Gleichzeitiges Anzeigen mehrerer Touren und eines
            Punktes](#Gleichzeitiges-Anzeigen-mehrerer-Touren-und-eines-Punktes)
        -   [Interaktive Oberfläche (muss freigeschaltet
            sein)](#Interaktive-Oberfläche-muss-freigeschaltet-sein)
